...
const db_name="appukutan"// set database name to this variable (as we are using da-name in many places)
const mongoUri = "mongodb+srv://Ahmed:@Dheelahmed1212@cluster0.oe0av.mongodb.net/appukutan";
...
discord_bot.on('ready',()=>{
    ...
    discord_bot.user.setActivity('njaaan!',{type:"Ath pinneeeeee!"})
})// bot logged in


discord_bot.login("ODQzNDMyNjc5MjA1ODk2MjEz.YKDx5A.A-4K_Of3wJxeIjFlC3wrIhIusZc")
